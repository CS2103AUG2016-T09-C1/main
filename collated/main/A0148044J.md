...
<VBox styleClass="background" xmlns="http://javafx.com/javafx/8.0.60" xmlns:fx="http://javafx.com/fxml/1" fx:controller="seedu.inbx0.ui.MainWindow">
  ...
  <AnchorPane fx:id="mainDisplayPlaceholder" prefHeight="758.0" prefWidth="1302.0" styleClass="grid-pane" stylesheets="@DarkTheme.css">
         <children>
            <HBox prefHeight="716.0" prefWidth="1300.0" AnchorPane.bottomAnchor="0.0" AnchorPane.leftAnchor="0.0" AnchorPane.rightAnchor="0.0" AnchorPane.topAnchor="0.0">
               <children>
                <AnchorPane>
                     <children>
                ...
                <AnchorPane fx:id="listDisplayPlaceholder">
                     <children>
                        <VBox styleClass="container" stylesheets="@DarkTheme.css" AnchorPane.bottomAnchor="0.0" AnchorPane.leftAnchor="0.0" AnchorPane.rightAnchor="0.0" AnchorPane.topAnchor="0.0">
                           <children>
                              ...
                              <VBox prefHeight="719.0" prefWidth="1150.0">
                                 <children>
